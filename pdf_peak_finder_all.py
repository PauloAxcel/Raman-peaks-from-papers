...
os.chdir(r"C:\Users\paulo\OneDrive - University of Birmingham\Desktop\birmingham_02\saliva\GUI for raman analysis\reading raman values from papers\saliva")
...
all_string.columns = list(range(sum(num)))

info_to_obtain = 'cm'
info = []
numbers = []

for m in range(sum(num)):
